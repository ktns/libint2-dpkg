...
{
const int vi = 0;
HRRPart1bra0ket0dp(inteval, &(inteval->stack[((hsi*18+67)*1+lsi)*1]), &(inteval->stack[((hsi*10+6)*1+lsi)*1]), &(inteval->stack[((hsi*6+0)*1+lsi)*1]),1);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*30+85)*1+lsi)*1]), &(inteval->stack[((hsi*15+16)*1+lsi)*1]), &(inteval->stack[((hsi*10+6)*1+lsi)*1]),1);
HRRPart1bra0ket0dd(inteval, &(inteval->stack[((hsi*36+31)*1+lsi)*1]), &(inteval->stack[((hsi*30+85)*1+lsi)*1]), &(inteval->stack[((hsi*18+67)*1+lsi)*1]),1);
}
}
}
const int hsi = 0;
