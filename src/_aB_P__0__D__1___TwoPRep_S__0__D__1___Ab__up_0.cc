...
{
const int vi = 0;
HRRPart1bra0ket0dp(inteval, &(inteval->stack[((hsi*54+201)*1+lsi)*1]), &(inteval->stack[((hsi*30+18)*1+lsi)*1]), &(inteval->stack[((hsi*18+0)*1+lsi)*1]),3);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*90+255)*1+lsi)*1]), &(inteval->stack[((hsi*45+48)*1+lsi)*1]), &(inteval->stack[((hsi*30+18)*1+lsi)*1]),3);
