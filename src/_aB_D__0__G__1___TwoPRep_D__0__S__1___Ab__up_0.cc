...
{
const int vi = 0;
HRRPart0bra0ket0dp(inteval, &(inteval->stack[((hsi*270+1005)*1+lsi)*1]), &(inteval->stack[((hsi*150+90)*1+lsi)*1]), &(inteval->stack[((hsi*90+0)*1+lsi)*1]),15);
HRRPart0bra0ket0fp(inteval, &(inteval->stack[((hsi*450+1275)*1+lsi)*1]), &(inteval->stack[((hsi*225+240)*1+lsi)*1]), &(inteval->stack[((hsi*150+90)*1+lsi)*1]),15);
