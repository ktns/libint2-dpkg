...
{
const int vi = 0;
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*450+4300)*1+lsi)*1]), &(inteval->stack[((hsi*210+150)*1+lsi)*1]), &(inteval->stack[((hsi*150+0)*1+lsi)*1]),10);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*630+4750)*1+lsi)*1]), &(inteval->stack[((hsi*280+360)*1+lsi)*1]), &(inteval->stack[((hsi*210+150)*1+lsi)*1]),10);
...
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*675+4300)*1+lsi)*1]), &(inteval->stack[((hsi*315+865)*1+lsi)*1]), &(inteval->stack[((hsi*225+640)*1+lsi)*1]),15);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*945+6280)*1+lsi)*1]), &(inteval->stack[((hsi*420+1180)*1+lsi)*1]), &(inteval->stack[((hsi*315+865)*1+lsi)*1]),15);
