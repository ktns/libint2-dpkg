...
{
const int vi = 0;
HRRPart1bra0ket0dp(inteval, &(inteval->stack[((hsi*180+1855)*1+lsi)*1]), &(inteval->stack[((hsi*100+60)*1+lsi)*1]), &(inteval->stack[((hsi*60+0)*1+lsi)*1]),10);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*300+2035)*1+lsi)*1]), &(inteval->stack[((hsi*150+160)*1+lsi)*1]), &(inteval->stack[((hsi*100+60)*1+lsi)*1]),10);
...
HRRPart1bra0ket0dp(inteval, &(inteval->stack[((hsi*270+1855)*1+lsi)*1]), &(inteval->stack[((hsi*150+400)*1+lsi)*1]), &(inteval->stack[((hsi*90+310)*1+lsi)*1]),15);
