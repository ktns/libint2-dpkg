...
{
const int vi = 0;
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*270+2644)*1+lsi)*1]), &(inteval->stack[((hsi*126+90)*1+lsi)*1]), &(inteval->stack[((hsi*90+0)*1+lsi)*1]),6);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*378+2914)*1+lsi)*1]), &(inteval->stack[((hsi*168+216)*1+lsi)*1]), &(inteval->stack[((hsi*126+90)*1+lsi)*1]),6);
...
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*450+2644)*1+lsi)*1]), &(inteval->stack[((hsi*210+534)*1+lsi)*1]), &(inteval->stack[((hsi*150+384)*1+lsi)*1]),10);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*630+3832)*1+lsi)*1]), &(inteval->stack[((hsi*280+744)*1+lsi)*1]), &(inteval->stack[((hsi*210+534)*1+lsi)*1]),10);
