...
{
const int vi = 0;
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*180+1816)*1+lsi)*1]), &(inteval->stack[((hsi*90+60)*1+lsi)*1]), &(inteval->stack[((hsi*60+0)*1+lsi)*1]),6);
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*270+1996)*1+lsi)*1]), &(inteval->stack[((hsi*126+150)*1+lsi)*1]), &(inteval->stack[((hsi*90+60)*1+lsi)*1]),6);
...
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*300+1816)*1+lsi)*1]), &(inteval->stack[((hsi*150+376)*1+lsi)*1]), &(inteval->stack[((hsi*100+276)*1+lsi)*1]),10);
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*450+2626)*1+lsi)*1]), &(inteval->stack[((hsi*210+526)*1+lsi)*1]), &(inteval->stack[((hsi*150+376)*1+lsi)*1]),10);
