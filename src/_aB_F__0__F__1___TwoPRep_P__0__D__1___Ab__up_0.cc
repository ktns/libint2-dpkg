...
{
const int vi = 0;
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*300+2950)*1+lsi)*1]), &(inteval->stack[((hsi*150+100)*1+lsi)*1]), &(inteval->stack[((hsi*100+0)*1+lsi)*1]),10);
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*450+3250)*1+lsi)*1]), &(inteval->stack[((hsi*210+250)*1+lsi)*1]), &(inteval->stack[((hsi*150+100)*1+lsi)*1]),10);
...
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*450+2950)*1+lsi)*1]), &(inteval->stack[((hsi*225+610)*1+lsi)*1]), &(inteval->stack[((hsi*150+460)*1+lsi)*1]),15);
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*675+4300)*1+lsi)*1]), &(inteval->stack[((hsi*315+835)*1+lsi)*1]), &(inteval->stack[((hsi*225+610)*1+lsi)*1]),15);
