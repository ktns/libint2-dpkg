...
{
const int vi = 0;
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*675+6354)*1+lsi)*1]), &(inteval->stack[((hsi*315+225)*1+lsi)*1]), &(inteval->stack[((hsi*225+0)*1+lsi)*1]),15);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*945+7029)*1+lsi)*1]), &(inteval->stack[((hsi*420+540)*1+lsi)*1]), &(inteval->stack[((hsi*315+225)*1+lsi)*1]),15);
...
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*945+6354)*1+lsi)*1]), &(inteval->stack[((hsi*441+1275)*1+lsi)*1]), &(inteval->stack[((hsi*315+960)*1+lsi)*1]),21);
HRRPart1bra0ket0hp(inteval, &(inteval->stack[((hsi*1323+9324)*1+lsi)*1]), &(inteval->stack[((hsi*588+1716)*1+lsi)*1]), &(inteval->stack[((hsi*441+1275)*1+lsi)*1]),21);
