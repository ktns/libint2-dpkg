...
{
const int vi = 0;
HRRPart1bra0ket0dp(inteval, &(inteval->stack[((hsi*108+1144)*1+lsi)*1]), &(inteval->stack[((hsi*60+36)*1+lsi)*1]), &(inteval->stack[((hsi*36+0)*1+lsi)*1]),6);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*180+1252)*1+lsi)*1]), &(inteval->stack[((hsi*90+96)*1+lsi)*1]), &(inteval->stack[((hsi*60+36)*1+lsi)*1]),6);
...
HRRPart1bra0ket0dp(inteval, &(inteval->stack[((hsi*180+1144)*1+lsi)*1]), &(inteval->stack[((hsi*100+246)*1+lsi)*1]), &(inteval->stack[((hsi*60+186)*1+lsi)*1]),10);
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*300+1648)*1+lsi)*1]), &(inteval->stack[((hsi*150+346)*1+lsi)*1]), &(inteval->stack[((hsi*100+246)*1+lsi)*1]),10);
