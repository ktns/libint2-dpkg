...
{
const int vi = 0;
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*450+4356)*1+lsi)*1]), &(inteval->stack[((hsi*225+150)*1+lsi)*1]), &(inteval->stack[((hsi*150+0)*1+lsi)*1]),15);
HRRPart1bra0ket0gp(inteval, &(inteval->stack[((hsi*675+4806)*1+lsi)*1]), &(inteval->stack[((hsi*315+375)*1+lsi)*1]), &(inteval->stack[((hsi*225+150)*1+lsi)*1]),15);
...
HRRPart1bra0ket0fp(inteval, &(inteval->stack[((hsi*630+4356)*1+lsi)*1]), &(inteval->stack[((hsi*315+900)*1+lsi)*1]), &(inteval->stack[((hsi*210+690)*1+lsi)*1]),21);
